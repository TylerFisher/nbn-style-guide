  ...
  grunt.initConfig({
    ...
    concat: {
      rb: {
        ...
        files: {
          '.compass/lib/north-by-northwestern-style-guide.rb': ['.compass/.template/style-guide.rb']
        }
      },
      gemspec: {
        options: {
        ...
        files: {
          '.compass/north-by-northwestern-style-guide.gemspec': ['.compass/.template/style-guide.gemspec']
        }
      }
    },
    ...
    exec: {
      ...
      ext: {
        cmd: 'cd .compass && bundle exec gem build north-by-northwestern-style-guide.gemspec && mv north-by-northwestern-style-guide-' + userConfig.client.version + '.gem ../north-by-northwestern-style-guide-' + userConfig.client.version + '.gem && cd ..'
      },
      install: {
        cmd: 'gem install north-by-northwestern-style-guide-' + userConfig.client.version + '.gem && rm north-by-northwestern-style-guide-' + userConfig.client.version + '.gem'
      },
      weinre: {
